...
export function ResourceNavigation(props: {
  canReset?: boolean;
  onBack?: () => void;
  hideBack?: boolean;
}) {
  ...
  return (
    <div className={$.resourceNavContainer}>
      ...
      history.length < 2 ? (
        ...
        <div
          className={$.resourceNavIcon}
          data-disabled={!props.onBack && !props.canReset && history.length < 2}
        >
      ...
      <div
        className={$.resourceNavIcon}
        data-disabled={history.length < 2}
